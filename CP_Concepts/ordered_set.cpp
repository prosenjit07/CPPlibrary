// it is a Policy Based DataStructure(pbds)
// all query time comp: log(n)
#include <bits/stdc++.h>
...
// less=Acending, greater=Decending,
...
int main()
{
    ...
    A.insert(2);
    A.insert(7);
    A.insert(2); // ordered set only contains unique values(skip)
